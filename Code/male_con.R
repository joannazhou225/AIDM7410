...
library("wordcloud2")
#wordcloud_tf
male_tf <- read.csv(file.choose(), header = TRUE, encoding="GBK", stringsAsFactors=FALSE)  # file.choose()
wordcloud2(male_tf,size = 0.6,color = "random-light",shape = "circle",backgroundColor = "gray20")

#wordcloud_tfidf
male_tfidf <- read.csv(file.choose(), header = TRUE, encoding="UTF-8", stringsAsFactors=FALSE)  # file.choose()
wordcloud2(male_tfidf,size = 0.6,color = "random-light",shape = "circle",backgroundColor = "gray20")
